...
namespace RabbitMQ.Client
{
    ...
    /// </summary>
    public class QueueingBasicConsumer : QueueingBasicConsumerBase
    {
        ...
        public QueueingBasicConsumer(IModel model, SharedQueue<BasicDeliverEventArgs> queue) : base(model, queue)
        {
        }
    }
