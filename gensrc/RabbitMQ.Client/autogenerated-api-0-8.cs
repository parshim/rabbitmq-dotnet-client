      ...
      switch (classId) {
        ...
        case 60: {
          switch (methodId) {
            ...
            case 100: {
              RabbitMQ.Client.Framing.Impl.v0_8.BasicRecoverAsync result = new RabbitMQ.Client.Framing.Impl.v0_8.BasicRecoverAsync();
              result.ReadArgumentsFrom(new RabbitMQ.Client.Impl.MethodArgumentReader(reader));
              return result;
            }
            case 110: {
            ...
            case 111: {
              RabbitMQ.Client.Framing.Impl.v0_8.BasicRecoverOk result = new RabbitMQ.Client.Framing.Impl.v0_8.BasicRecoverOk();
              result.ReadArgumentsFrom(new RabbitMQ.Client.Impl.MethodArgumentReader(reader));
              return result;
            }
            default: break;
