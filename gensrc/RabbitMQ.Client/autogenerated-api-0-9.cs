...
namespace RabbitMQ.Client.Framing.v0_9 {
  public class Protocol: RabbitMQ.Client.Framing.Impl.v0_9.ProtocolBase {
    ...
    public override int Revision { get { return 0; } }
      ...
      switch (classId) {
        ...
        case 60: {
          switch (methodId) {
            ...
            case 100: {
              RabbitMQ.Client.Framing.Impl.v0_9.BasicRecoverAsync result = new RabbitMQ.Client.Framing.Impl.v0_9.BasicRecoverAsync();
              result.ReadArgumentsFrom(new RabbitMQ.Client.Impl.MethodArgumentReader(reader));
              return result;
            }
            case 110: {
            ...
            case 111: {
              RabbitMQ.Client.Framing.Impl.v0_9.BasicRecoverOk result = new RabbitMQ.Client.Framing.Impl.v0_9.BasicRecoverOk();
              result.ReadArgumentsFrom(new RabbitMQ.Client.Impl.MethodArgumentReader(reader));
              return result;
            }
            default: break;
...
namespace RabbitMQ.Client.Framing.Impl.v0_9 {
  ...
  public class Model: RabbitMQ.Client.Impl.ModelBase {
    ...
    public override void _Private_ExchangeBind(
      ...
      System.Collections.IDictionary @arguments)
    {
      throw new UnsupportedMethodException("_Private_ExchangeBind");
    }
    public override void _Private_ExchangeUnbind(
      ...
      System.Collections.IDictionary @arguments)
    {
      throw new UnsupportedMethodException("_Private_ExchangeUnbind");
    }
      ...
      System.Collections.IDictionary @arguments)
    {
      ...
      __req.m_exclusive = @exclusive;
      __req.m_nowait = @nowait;
      __req.m_filter = @arguments;
      ModelSend(__req,null,null);
    }
    public override void _Private_ConfirmSelect(
      System.Boolean @nowait)
    {
      throw new UnsupportedMethodException("_Private_ConfirmSelect");
    }
    ...
    public override void BasicNack(
      ...
      System.Boolean @requeue)
    {
      throw new UnsupportedMethodException("BasicNack");
    }
